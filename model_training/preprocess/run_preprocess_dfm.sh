...
python prepare_file_domain.py --source_path ./dfm_data --tokenizer_path tokenizer/gptneox --destination_path ./dfm_dataset_preproc --short_name $DATASET_SHORT_NAME --split train
...
python prepare_file_domain.py --source_path ./dfm_data --tokenizer_path tokenizer/gptneox --destination_path ./dfm_dataset_preproc --short_name $DATASET_SHORT_NAME --split valid --chunk_size 131136
